...
const DEFINITIONS = [
  ...
  ['Pass Sonar', 'Groups passes by starting zone and direction. Wedge length shows relative pass frequency. Wedge colour shows average pass accuracy on a red-to-green scale.'],
...
const LOGGING_GUIDE = [
  ...
  ['Restart Takers And Touches', 'Deadball pass or carry restarts, solo-plus-go carries, and placed-ball shots all count as touches for the restart taker.'],
