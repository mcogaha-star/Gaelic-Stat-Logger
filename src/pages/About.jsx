...
const DEFINITIONS = [
  ...
  ['Pass Sonar', 'Groups passes by starting zone and direction. Wedge length shows relative pass frequency. Wedge colour shows average pass accuracy score using `-- = -3`, `- = -1`, `+ = 1`, and `++ = 3`.'],
