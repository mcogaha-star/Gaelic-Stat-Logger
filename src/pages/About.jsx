...
const DEFINITIONS = [
  ...
  ['Touches', 'Times a player gains or takes control of the ball: completed passes received, broken-retained recoveries, kickouts won, throw-ins won, turnovers recovered, qualifying dead-ball restarts taken, and shot recoveries logged to a player.'],
